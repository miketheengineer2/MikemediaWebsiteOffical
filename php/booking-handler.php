...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($adminMailSent && $clientMailSent) {
        echo json_encode(array("status" => "success", "message" => "Booking request sent successfully"));
    } else {
        echo json_encode(array("status" => "error", "message" => "Failed to send booking request"));
    }
} else {
